...
void ApplicationFunctionSet::ApplicationFunctionSet_SerialPortDataAnalysis(void)
{
  ...
  uint8_t c = "";
  if (millis() - Application_SmartRobotCarxxx0.userControlTime >= 2000 && Application_SmartRobotCarxxx0.Functional_Mode == UserControl) {
    Application_SmartRobotCarxxx0.Motion_Control = stop_it;
    Application_SmartRobotCarxxx0.Functional_Mode = Standby_mode;
  }
  if (Serial.available() > 0)
  {
    ...
    if (a.indexOf(":") != -1) {
      ...
      String speedA = a.substring(0, a.indexOf(":"));
      String speedB = a.substring(a.indexOf(":")+1);      
      Application_SmartRobotCarxxx0.Functional_Mode = UserControl;
      AppMotor.DeviceDriverSet_Motor_control(1, speedA.toInt(), 1, speedB.toInt(), control_enable);
      }
    if (a == "360") {
      Application_SmartRobotCarxxx0.userControlTime = millis();      
      Application_SmartRobotCarxxx0.Functional_Mode = UserControl;
      AppMotor.DeviceDriverSet_Motor_control(1, 100, 0, 100, control_enable);
      }
    if (a == "STOP") {
      Application_SmartRobotCarxxx0.Motion_Control = stop_it;
      Application_SmartRobotCarxxx0.Functional_Mode = Standby_mode;          
